// Vercel serverless function for EstateLux.
// Keep RENTCAST_API_KEY in Vercel Environment Variables. Never put the key in app.js.
...
export default async function handler(req, res) {
  try {
    ...
    return res.status(200).json({listings:Array.isArray(data) ? data : (data.listings || [])});
  } catch (error) {
